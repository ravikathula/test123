        ...
        <div class="row">
            <div class="col-lg-6 col-lg-push-3 col-md-6 col-md-push-3 col-sm-12">
                <div class="login-box-body">
                    <p class="login-box-msg"><?php echo Yii::t('campaign_reports', 'Login to view reports');?></p>
                    <?php
                    /**
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label><?php echo Yii::t('campaign_reports', 'Password');?></label>
                                <?php echo CHtml::passwordField('password', null, array('class' => 'form-control')); ?>
                            </div>
                        </div>
                    </div>
                    <div class="row">
