...
/**
 * OptionCronProcessEmailBoxMonitors
 * 
...
class OptionCronProcessEmailBoxMonitors extends OptionBase
{
    // settings category
    protected $_categoryName = 'system.cron.process_email_box_monitors';
