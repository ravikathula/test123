...
class DeliveryServer extends ActiveRecord
{
    ...
    public function rules()
    {
        $rules = array(
            ...
            array('type, name, hostname, username, password, from_email, from_name', 'length', 'min' => 2, 'max'=>150),
    ...
    */
    ...
    public function attributeHelpTexts()
    {
        $texts = array(
            ...
            'daily_quota'               => Yii::t('servers', 'In case there are limits that apply for sending with this server, you can set a daily quota for it and it will only send in one day as many emails as you set here. Set it to 0 in order to not apply any hourly limit.'),
    ...
    public function saveStatus($status = null)
    {
        ...
        return Yii::app()->getDb()->createCommand()->update($this->tableName(), $attributes, 'server_id = :sid', array(':sid' => (int)$this->server_id));
    }
