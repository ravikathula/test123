...
class CampaignHelper
{
     ...
     * @return mixed
     */
    public static function fetchContentForRemoteContentTag($content, Campaign $campaign)
    {
        ...
        foreach ($multiMatches[0] as $fullHtml) {
            ...
            if ($campaign) {
                $cacheKey      = sha1(__METHOD__ . $fullHtml . $campaign->campaign_uid);
            ...
            if ($remoteContent === false) {
                ...
                preg_match_all($attributesPattern, $fullHtml, $matches, PREG_SET_ORDER);
                if (empty($matches)) {
                    continue;
                }
