...
class List_subscribersController extends Controller
{
    ...
    public function actionIndex($list_uid)
    {
        ...
        foreach ($subscribers as $index => $subscriber) {
            ...
            // since 1.5.3
            $actions[] = CHtml::link(IconHelper::make('export'), array('list_subscribers/profile_export', 'list_uid' => $list->list_uid, 'subscriber_uid' => $subscriber->subscriber_uid), array('title' => Yii::t('app', 'Export profile info'), 'class' => 'btn btn-primary btn-flat btn-xs btn-export-subscriber-profile-info'));
