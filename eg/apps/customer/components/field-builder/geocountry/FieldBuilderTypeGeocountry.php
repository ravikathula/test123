...
class FieldBuilderTypeGeocountry extends FieldBuilderType
{
    public function run()
    {
        $apps       = Yii::app()->apps;
        $baseAlias  = 'customer.components.field-builder.geocountry.behaviors.FieldBuilderTypeGeocountry';
