...
/**
 * FieldBuilderTypeConsentCheckbox
 * 
...
class FieldBuilderTypeConsentCheckbox extends FieldBuilderType
{
    /**
     * @inheritdoc
     */
    public function run()
    {
        $apps       = Yii::app()->apps;
        $hooks      = Yii::app()->hooks;
        $baseAlias  = 'customer.components.field-builder.consentcheckbox.behaviors.FieldBuilderTypeConsentCheckbox';
