...
class FieldBuilderTypeGeocity extends FieldBuilderType
{
    public function run()
    {
        $apps       = Yii::app()->apps;
        $baseAlias  = 'customer.components.field-builder.geocity.behaviors.FieldBuilderTypeGeocity';
