...
class FieldBuilderTypeGeostate extends FieldBuilderType
{
    public function run()
    {
        $apps       = Yii::app()->apps;
        $baseAlias  = 'customer.components.field-builder.geostate.behaviors.FieldBuilderTypeGeostate';
