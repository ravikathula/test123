...
class FieldBuilderTypeCheckbox extends FieldBuilderType
{
    /**
     * @inheritdoc
     */
    public function run()
    {
        $apps       = Yii::app()->apps;
        $hooks      = Yii::app()->hooks;
        $baseAlias  = 'customer.components.field-builder.checkbox.behaviors.FieldBuilderTypeCheckbox';
