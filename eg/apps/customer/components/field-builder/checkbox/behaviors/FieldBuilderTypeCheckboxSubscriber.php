...
/**
 * FieldBuilderTypeCheckboxSubscriber
 * 
...
class FieldBuilderTypeCheckboxSubscriber extends CBehavior
{
    /**
     * @param CEvent $event
     * @throws CException
    ...
    protected function getValueModels()
    {
        ...
        $models = ListFieldCheckbox::model()->findAllByAttributes(array(
        ...
        foreach ($models as $model) {
            ...
            $defaultValue = empty($valueModel->value) ? ListFieldCheckbox::parseDefaultValueTags($model->default_value, $subscriber) : $valueModel->value;
    ...
    protected function buildFieldArray($model)
    {
        ...
        if ($field->visibility == ListFieldCheckbox::VISIBILITY_VISIBLE || Yii::app()->apps->isAppName('customer')) {
