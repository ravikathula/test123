...
class FieldBuilderTypeCountry extends FieldBuilderType
{
    public function run()
    {
        $apps       = Yii::app()->apps;
        $hooks      = Yii::app()->hooks;
        $baseAlias  = 'customer.components.field-builder.country.behaviors.FieldBuilderTypeCountry';
