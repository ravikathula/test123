                    ...
                    <ul class="custom-list">
                        ...
                        <?php if ($campaign->isAutoresponder) { ?>
                            <?php if (!empty($campaign->option->autoresponder_open_campaign_id)) { ?>
                                <li><span class="cl-span"><?php echo Yii::t('campaigns', 'Campaign to send for');?></span><span class="cl-span"><?php echo !empty($campaign->option->autoresponder_open_campaign_id) ? $campaign->option->autoresponderOpenCampaign->name : null;?></span></li>
                            <?php } ?>

                            <?php if (!empty($campaign->option->autoresponder_open_campaign_id)) { ?>
                                <li><span class="cl-span"><?php echo Yii::t('campaigns', 'Current opens count for target campaign');?></span><span class="cl-span"><?php echo !empty($campaign->option->autoresponder_open_campaign_id) ? (int)$campaign->option->autoresponderOpenCampaign->stats->getUniqueOpensCount(true) : null;?></span></li>
                            <?php } ?>
