        ...
        <div class="box box-primary borderless">
            <div class="box-header">
                ...
                <div class="pull-right">
                    <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                        ->add(CHtml::link(IconHelper::make('cancel') . Yii::t('app', 'Cancel'), array('delivery_servers/index'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Cancel'))))
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <?php
                    $index = 0;
                    $formFields = $server->getFormFieldsDefinition(array(
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php echo Yii::t('servers', 'The url where this server expects to receive webhooks requests to process bounces and complaints is: {url}. Please check and make sure the webhook has been created!', array('{url}' => sprintf('<strong>%s</strong>', $server->getDswhUrl())));?><br />
                        <?php echo Yii::t('servers', 'You can configure your TipiMail account from: {url}', array(
                            '{url}' => CHtml::link('https://app.tipimail.com/#/app/settings/webhooks', 'https://app.tipimail.com/#/app/settings/webhooks', array('target' => '_blank')),
                        ));?>
                    </div>
                </div>
            </div>
