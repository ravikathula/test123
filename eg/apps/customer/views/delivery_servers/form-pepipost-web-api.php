            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php echo Yii::t('servers', 'Please go to {url} and add {webhook} for following events: Emails are bounced, Emails are unsubscribed, Emails are abuse!', array(
                            '{url}'     => CHtml::link(Yii::t('servers', 'Webhooks Area'), 'https://app1.pepipost.com/index.php/settings/index#tab_3', array('target' => '_blank')),
