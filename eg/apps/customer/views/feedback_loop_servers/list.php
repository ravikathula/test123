...
if ($viewCollection->renderContent) {
     ...
     * @since 1.3.9.2
     */
    $itemsCount = FeedbackLoopServer::model()->countByAttributes(array(
        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ...
                    ->add(CHtml::link(IconHelper::make('create') . Yii::t('app', 'Create new'), array('feedback_loop_servers/create'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Create new'))))
                    ...
                    ->add(CHtml::link(IconHelper::make('refresh') . Yii::t('app', 'Refresh'), array('feedback_loop_servers/index'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Refresh'))))
