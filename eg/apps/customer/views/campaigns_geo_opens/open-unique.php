        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->add($this->widget('common.components.web.widgets.GridViewToggleColumns', array('model' => $model, 'columns' => array('campaign.name', 'subscriber.email', 'open_times', 'ip_address', 'user_agent', 'date_added')), true))
                    ->add(CHtml::link(IconHelper::make('view') . Yii::t('campaign_reports', 'View all opens'), array('campaigns_geo_opens/all'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('campaign_reports', 'View all opens'))))
                    ->addIf(CHtml::link(IconHelper::make('export') . Yii::t('campaign_reports', 'Export reports'), array('campaigns_geo_opens/export_unique'), array('target' => '_blank', 'class' => 'btn btn-primary btn-flat', 'title' => Yii::t('campaign_reports', 'Export reports'))), !empty($canExportStats))
                    ->render();
                ?>
            </div>
