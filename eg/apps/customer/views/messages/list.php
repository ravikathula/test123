...
if ($viewCollection->renderContent) {
     ...
     * @since 1.3.9.2
     */
    $itemsCount = CustomerMessage::model()->countByAttributes(array(
        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->add($this->widget('common.components.web.widgets.GridViewToggleColumns', array('model' => $message, 'columns' => array('title', 'message', 'status', 'date_added')), true))
                    ->add(CHtml::link(Yii::t('app', 'Mark all as seen'), array('messages/mark_all_as_seen'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Mark all as seen'))))
                    ->addIf(CHtml::link(IconHelper::make('export') . Yii::t('app', 'Export'), array('messages/export'), array('target' => '_blank', 'class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Export'))), $itemsCount)
                    ->add(CHtml::link(IconHelper::make('refresh') . Yii::t('app', 'Refresh'), array('messages/index'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Refresh'))))
                    ->render();
                ?>
            </div>
