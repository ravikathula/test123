...
if ($viewCollection->renderContent) { ?>
    ...
    <?php if (!empty($renderItems)) { ?>
    <div id="campaigns-overview-wrapper" data-url="<?php echo $this->createUrl('dashboard/campaigns');?>">
        <!-- ajax content -->
    </div>
    <?php } ?>
        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->addIf(CHtml::link(IconHelper::make('export') . Yii::t('app', 'Export'), array('dashboard/export_recent_activity'), array('target' => '_blank', 'class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Export'))), count($timelineItems))
                    ->render();
                ?>
            </div>
            <div class="clearfix"><!-- --></div>
