                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <?php echo $form->textField($campaign, 'name', $campaign->getHtmlOptions('name', array(
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <?php echo $form->dropDownList($campaign, 'group_id', $groupsArray, $campaign->getHtmlOptions('group_id', array(
                                'disabled' => $campaign->getIsPaused(),
                            ))); ?>
