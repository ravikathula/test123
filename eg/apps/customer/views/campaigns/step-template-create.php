                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="pull-right">
                            ...
                            <?php if (!empty($templateContentUrls)) { ?>
                            <button type="button" class="btn btn-primary btn-flat btn-template-click-actions-list-fields">
                            ...
                            <?php if (!empty($templateContentUrls)) { ?>
                            <button type="button" class="btn btn-primary btn-flat btn-template-click-actions">
                            ...
                            <?php echo CHtml::link(Yii::t('campaigns', 'UTM tags'), '#google-utm-tags-modal', array('class' => 'btn btn-primary btn-flat', 'data-toggle' => 'modal', 'title' => Yii::t('campaigns', 'Google UTM tags')));?>
                            
                            <?php if (!empty($campaign->option) && $campaign->option->plain_text_email == CampaignOption::TEXT_YES) { ?>
                                <button type="button" class="btn btn-primary btn-flat btn-plain-text" data-showtext="<?php echo Yii::t('campaigns', 'Show plain text version');?>" data-hidetext="<?php echo Yii::t('campaigns', 'Hide plain text version');?>" style="display:<?php echo $template->isOnlyPlainText ? 'none':'';?>;"><?php echo Yii::t('campaigns', 'Show plain text version');?></button>
                            <?php } ?>

                            <button type="button" class="btn btn-primary btn-flat btn-toggle-random-content">
                            ...
                            <button type="submit" id="is_next" name="is_next" value="0" class="btn btn-primary btn-flat btn-go-next"><?php echo Yii::t('campaigns', 'Save template changes');?></button>
                        </div>
                    </div>
                </div>
                <div class="clearfix"><!-- --></div>
