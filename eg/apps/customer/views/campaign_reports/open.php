        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ...
                    ->add(CHtml::link(IconHelper::make('view') . Yii::t('campaign_reports', 'View unique opens'), array($this->campaignReportsController . '/open_unique', 'campaign_uid' => $campaign->campaign_uid), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('campaign_reports', 'View unique opens only'))))
                    ->addIf(CHtml::link(IconHelper::make('export') . Yii::t('campaign_reports', 'Export reports'), array($this->campaignReportsExportController . '/open', 'campaign_uid' => $campaign->campaign_uid), array('target' => '_blank', 'class' => 'btn btn-primary btn-flat', 'title' => Yii::t('campaign_reports', 'Export reports'))), !empty($canExportStats))
                        ...
                        array(
                            ...
                            'buttons'   => array(
                                ...
                                'bysubscriber'  => array(
                                    ...
                                    'url'       => 'Yii::app()->createUrl(Yii::app()->controller->campaignReportsController . "/open_by_subscriber", array("campaign_uid" => $data->campaign->campaign_uid, "subscriber_uid" => $data->subscriber->subscriber_uid))',
                                    'imageUrl'  => null,
