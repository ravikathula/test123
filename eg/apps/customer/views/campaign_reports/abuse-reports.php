        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ...
                    ->add($this->widget('common.components.web.widgets.GridViewToggleColumns', array('model' => $reports, 'columns' => array('subscriber_info', 'reason', 'log', 'ip_address', 'user_agent', 'date_added')), true))
                    ->add(CHtml::link(IconHelper::make('refresh') . Yii::t('app', 'Refresh'), array($this->campaignReportsController . '/abuse_reports', 'campaign_uid' => $campaign->campaign_uid), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Refresh'))))
                    ->render();
                ?>
    		</div>
