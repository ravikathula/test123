				...
				<div class="col-md-7 login-form-office text-left vcenter">
                   <!-- <p class="login-box-msg"><?php echo Yii::t('users', 'Sign in to start your session');?></p>-->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group custominput">
								...
								<label for="CustomerLogin_password"><span>Password</span></label>
                    ...
                    <div class="row">
						...
						$('#CustomerLogin_email, #CustomerLogin_password').prop('required',true);
						
						$('#CustomerLogin_email').keyup(function(){
						if($(this).val()==''){
