            ...
            <div class="box-header">
                ...
                <div class="pull-right">
                    <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                        ...
                        ->addIf(CHtml::link(IconHelper::make('export') . Yii::t('list_export', 'Export segment'), array('list_segments_export/index', 'list_uid' => $list->list_uid, 'segment_uid' => $segment->segment_uid), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('list_export', 'Export segment'))), !$segment->isNewRecord && !empty($canExport))
                        ->render();
                    ?>
                </div>
                <div class="clearfix"><!-- --></div>
