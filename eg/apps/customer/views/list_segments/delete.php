    ...
    <div class="box box-primary borderless">
        ...
        <div class="box-body">
            ...
            <div class="alert alert-danger alert-dismissable">
                <i class="fa fa-ban"></i>
                <strong>
                    <?php echo Yii::t('lists', 'This action will remove {campaigns} campaigns.', array(
                        '{campaigns}'   => $campaignsCount,
                    ));?>
                    <br />
                    <?php echo Yii::t('lists', 'Are you still sure you want to remove this list segment? There is no coming back after you do it!');?>
                </strong>
            </div>
