        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->addIf($this->widget('common.components.web.widgets.GridViewToggleColumns', array('model' => $list, 'columns' => array('list_uid', 'name', 'display_name', 'subscribers_count', 'opt_in', 'opt_out', 'merged', 'date_added', 'last_updated')), true), $itemsCount)
                    ->addIf(CHtml::link(IconHelper::make('fa-users') . Yii::t('app', 'All subscribers'), array('lists/all_subscribers'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'All subscribers'))), $itemsCount)
                    ->add(CHtml::link(IconHelper::make('create') . Yii::t('app', 'Create new'), array('lists/create'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Create new'))))
                    ->addIf(CHtml::link(IconHelper::make('export') . Yii::t('app', 'Export'), array('lists/export'), array('target' => '_blank', 'class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Export'))), $itemsCount)
                    ->add(CHtml::link(IconHelper::make('refresh') . Yii::t('app', 'Refresh'), array('lists/index'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Refresh'))))
                    ->render();
                ?>
            </div>
                ...
                $this->widget('zii.widgets.grid.CGridView', $hooks->applyFilters('grid_view_properties', array(
                    ...
                    'columns' => $hooks->applyFilters('grid_view_columns', array(
                        ...
                        array(
                            ...
                            'value' => 'Yii::app()->format->formatNumber($data->confirmedSubscribersCount) . " / " . Yii::app()->format->formatNumber($data->subscribersCount)',
                            'filter'=> false,
                        ),
                        array(
                            'name'  => 'opt_in',
