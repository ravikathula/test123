    ...
    <div class="box box-primary borderless">
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php echo HtmlHelper::accessLink(IconHelper::make('refresh') . Yii::t('app', 'Refresh'), array('payment_gateways/index'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Refresh')));?>
                        ...
                        array(
                            ...
                            'buttons'   => array(
                                'page' => array(
                                    ...
                                    'url'       => '$data["page_url"]',
                                    'imageUrl'  => null,
                                    'options'   => array('title' => Yii::t('payment_gateways', 'Gateway detail page'), 'class'=>'btn btn-primary btn-flat btn-flat'),
