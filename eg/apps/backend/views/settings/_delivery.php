        ...
        <div class="row">
            ...
            <div class="col-lg-2">
                <div class="form-group">
                    ...
                    <?php echo $form->numberField($cronDeliveryModel, 'max_bounce_rate', $cronDeliveryModel->getHtmlOptions('max_bounce_rate')); ?>
            ...
            <div class="col-lg-2">
                <div class="form-group">
                    <?php echo $form->labelEx($cronDeliveryModel, 'delete_campaign_delivery_logs');?>
                    <?php echo $form->dropDownList($cronDeliveryModel, 'delete_campaign_delivery_logs', $cronDeliveryModel->getYesNoOptions(), $cronDeliveryModel->getHtmlOptions('delete_campaign_delivery_logs')); ?>
                    <?php echo $form->error($cronDeliveryModel, 'delete_campaign_delivery_logs');?>
                </div>
            </div>
        </div>
        <hr />
