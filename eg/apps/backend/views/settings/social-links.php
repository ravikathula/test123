    ...
    if ($collection->renderForm) {
        ...
        <div class="box box-primary borderless">
            <div class="box-header">
                <div class="pull-left">
                    <h3 class="box-title"><?php echo Yii::t('settings', 'Social links')?></h3>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <?php echo $form->textField($model, 'twitter', $model->getHtmlOptions('twitter')); ?>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <?php echo $form->textField($model, 'linkedin', $model->getHtmlOptions('linkedin')); ?>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <?php echo $form->textField($model, 'instagram', $model->getHtmlOptions('instagram')); ?>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <?php echo $form->textField($model, 'youtube', $model->getHtmlOptions('youtube')); ?>
