        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ...
                    ->addIf(CHtml::link(IconHelper::make('upload') . Yii::t('email_templates', 'Upload template'), '#template-upload-modal', array('class' => 'btn btn-primary btn-flat', 'data-toggle' => 'modal', 'title' => Yii::t('email_templates', 'Upload template'))), AccessHelper::hasRouteAccess('email_templates_gallery/upload'))
                    ->add(HtmlHelper::accessLink(IconHelper::make('create') . Yii::t('app', 'Create new'), array('email_templates_gallery/create'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Create new'))))
                    ->add(HtmlHelper::accessLink(IconHelper::make('refresh') . Yii::t('app', 'Refresh'), array('email_templates_gallery/index'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Refresh'))))
                    ->render();
                ?>
            </div>
                ...
                $this->widget('zii.widgets.grid.CGridView', $hooks->applyFilters('grid_view_properties', array(
                    ...
                    'columns' => $hooks->applyFilters('grid_view_columns', array(
                        array(
                            'name'  => 'screenshot',
                            'type'  => 'raw',
                            'value' => 'CHtml::link(CHtml::image($data->getScreenshotSrc(120, 120), "", array("class" => "img-round")), Yii::app()->createUrl(\'email_templates_gallery/preview\', array(\'template_uid\' => $data->template_uid)), array("class" => "preview-email-template", "title" => Yii::t("email_templates", "Preview") . " " . $data->name))',
                            'filter'=> false,
                        ),
                        array(
                            'name'  => 'name',
                        ...
                        array(
                            ...
                            'buttons'   => array(
                                'update' => array(
                                    ...
                                    'url'       => 'Yii::app()->createUrl("email_templates_gallery/update", array("template_uid" => $data->template_uid))',
                                    'imageUrl'  => null,
                                ...
                                'copy' => array(
                                    ...
                                    'url'       => 'Yii::app()->createUrl("email_templates_gallery/copy", array("template_uid" => $data->template_uid))',
                                    'imageUrl'  => null,
                                ...
                                'delete' => array(
                                    ...
                                    'url'       => 'Yii::app()->createUrl("email_templates_gallery/delete", array("template_uid" => $data->template_uid))',
                                    'imageUrl'  => null,
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    $form = $this->beginWidget('CActiveForm', array(
                        'action'        => array('email_templates_gallery/upload'),
