...
<div class="col-md-7 login-form-office text-left vcenter">
          <!--  <p class="login-box-msg"><?php //echo Yii::t('customer', 'Forgot password?');?></p>-->
			<div class="row">
                        <div class="col-lg-12 logintitlediv">
						<h4 class="login-title"><?php echo Yii::t('customer', 'Forgot password?');?></h4>
						</div>
						</div>
            <?php
            /**
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group custominput">
						...
						<label for="UserPasswordReset_email"><span>Email</span></label>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group text-right">
                        <a href="<?php echo $this->createUrl('guest/index');?>" class="btn btn-flat btn-default"><?php echo IconHelper::make('prev') . '&nbsp;' . Yii::t('users', 'Go to login');?></a>
                    </div>
                    <div class="">
			...
			<script>
						...
						$('#UserPasswordReset_email').prop('required',true);
						
						$('#UserPasswordReset_email').keyup(function(){
						if($(this).val()==''){
