    ...
    if ($collection->renderForm) {
        ...
        <div class="box box-primary borderless">
            <div class="box-header">
                ...
                <div class="pull-right">
                    <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                        ->addIf(HtmlHelper::accessLink(IconHelper::make('create') . Yii::t('app', 'Create new'), array('email_box_monitors/create'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Create new'))), !$server->isNewRecord)
                        ->add(HtmlHelper::accessLink(IconHelper::make('cancel') . Yii::t('app', 'Cancel'), array('email_box_monitors/index'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Cancel'))))
            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <?php echo $form->dropDownList($server, 'identifySubscribersBy', $server->getIdentifySubscribersByList(), $server->getHtmlOptions('identifySubscribersBy')); ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <?php $this->renderPartial('_conditions', compact('form', 'server'));?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
